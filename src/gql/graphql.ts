...
export type GetCurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id?: string | null, slug?: string | null, player?: { __typename?: 'Player', id?: string | null, gamerTag?: string | null } | null } | null };

export type GetPlayerSetsQueryVariables = Exact<{
...
export type GetPlayerSetsQuery = { __typename?: 'Query', player?: { __typename?: 'Player', id?: string | null, sets?: { __typename?: 'SetConnection', pageInfo?: { __typename?: 'PageInfo', totalPages?: number | null } | null, nodes?: Array<{ __typename?: 'Set', id?: string | null, fullRoundText?: string | null, displayScore?: string | null, totalGames?: number | null, winnerId?: number | null, completedAt?: any | null, event?: { __typename?: 'Event', id?: string | null, name?: string | null, tournament?: { __typename?: 'Tournament', id?: string | null, name?: string | null } | null } | null, games?: Array<{ __typename?: 'Game', id?: string | null, selections?: Array<{ __typename?: 'GameSelection', selectionType?: GameSelectionType | null, selectionValue?: number | null, entrant?: { __typename?: 'Entrant', id?: string | null } | null } | null> | null } | null> | null, slots?: Array<{ __typename?: 'SetSlot', entrant?: { __typename?: 'Entrant', id?: string | null, name?: string | null, participants?: Array<{ __typename?: 'Participant', id?: string | null, player?: { __typename?: 'Player', id?: string | null } | null, user?: { __typename?: 'User', id?: string | null } | null } | null> | null } | null } | null> | null } | null> | null } | null } | null };

export type TournamentsByStateQueryVariables = Exact<{
  perPage?: InputMaybe<Scalars['Int']['input']>;
  state: Scalars['String']['input'];
  videogameId: Scalars['ID']['input'];
}>;


export type TournamentsByStateQuery = { __typename?: 'Query', tournaments?: { __typename?: 'TournamentConnection', nodes?: Array<{ __typename?: 'Tournament', id?: string | null, name?: string | null, addrState?: string | null, venueAddress?: string | null, numAttendees?: number | null, startAt?: any | null, slug?: string | null, images?: Array<{ __typename?: 'Image', id?: string | null, url?: string | null, height?: number | null, width?: number | null, type?: string | null } | null> | null } | null> | null } | null };
...
export const GetPlayerSetsDocument = gql`
...
/**
 * __useGetPlayerSetsQuery__
 *
 * To run a query within a React component, call `useGetPlayerSetsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPlayerSetsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPlayerSetsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetPlayerSetsQuery(baseOptions: Apollo.QueryHookOptions<GetPlayerSetsQuery, GetPlayerSetsQueryVariables> & ({ variables: GetPlayerSetsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>(GetPlayerSetsDocument, options);
      }
export function useGetPlayerSetsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>(GetPlayerSetsDocument, options);
        }
// @ts-ignore
export function useGetPlayerSetsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>): Apollo.UseSuspenseQueryResult<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>;
export function useGetPlayerSetsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>): Apollo.UseSuspenseQueryResult<GetPlayerSetsQuery | undefined, GetPlayerSetsQueryVariables>;
export function useGetPlayerSetsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>(GetPlayerSetsDocument, options);
        }
export type GetPlayerSetsQueryHookResult = ReturnType<typeof useGetPlayerSetsQuery>;
export type GetPlayerSetsLazyQueryHookResult = ReturnType<typeof useGetPlayerSetsLazyQuery>;
export type GetPlayerSetsSuspenseQueryHookResult = ReturnType<typeof useGetPlayerSetsSuspenseQuery>;
export type GetPlayerSetsQueryResult = Apollo.QueryResult<GetPlayerSetsQuery, GetPlayerSetsQueryVariables>;
export const TournamentsByStateDocument = gql`
    query TournamentsByState($perPage: Int, $state: String!, $videogameId: ID!) {
  tournaments(
    query: {perPage: $perPage, filter: {addrState: $state, upcoming: true, videogameIds: [$videogameId]}, sortBy: "startAt asc"}
  ) {
    nodes {
      id
      name
...
/**
 * __useTournamentsByStateQuery__
 *
 * To run a query within a React component, call `useTournamentsByStateQuery` and pass it any options that fit your needs.
 * When your component renders, `useTournamentsByStateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTournamentsByStateQuery({
 *   variables: {
 *      perPage: // value for 'perPage'
 *      state: // value for 'state'
 *      videogameId: // value for 'videogameId'
 *   },
 * });
 */
export function useTournamentsByStateQuery(baseOptions: Apollo.QueryHookOptions<TournamentsByStateQuery, TournamentsByStateQueryVariables> & ({ variables: TournamentsByStateQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TournamentsByStateQuery, TournamentsByStateQueryVariables>(TournamentsByStateDocument, options);
      }
export function useTournamentsByStateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TournamentsByStateQuery, TournamentsByStateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TournamentsByStateQuery, TournamentsByStateQueryVariables>(TournamentsByStateDocument, options);
        }
// @ts-ignore
export function useTournamentsByStateSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TournamentsByStateQuery, TournamentsByStateQueryVariables>): Apollo.UseSuspenseQueryResult<TournamentsByStateQuery, TournamentsByStateQueryVariables>;
export function useTournamentsByStateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TournamentsByStateQuery, TournamentsByStateQueryVariables>): Apollo.UseSuspenseQueryResult<TournamentsByStateQuery | undefined, TournamentsByStateQueryVariables>;
export function useTournamentsByStateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TournamentsByStateQuery, TournamentsByStateQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TournamentsByStateQuery, TournamentsByStateQueryVariables>(TournamentsByStateDocument, options);
        }
export type TournamentsByStateQueryHookResult = ReturnType<typeof useTournamentsByStateQuery>;
export type TournamentsByStateLazyQueryHookResult = ReturnType<typeof useTournamentsByStateLazyQuery>;
export type TournamentsByStateSuspenseQueryHookResult = ReturnType<typeof useTournamentsByStateSuspenseQuery>;
export type TournamentsByStateQueryResult = Apollo.QueryResult<TournamentsByStateQuery, TournamentsByStateQueryVariables>;